(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_2e75da._.js", {
...
const Todo = ({ todo, todos, setTodos })=>{
    ...
    const handleSave = ()=>{
        if (!setTodos) {
            console.error("setTodos is not defined");
            return;
        }
        const updatedTodos = todos.map((task)=>task.id === todo.id ? {
                ...task,
...
_s(Todo, "mE8/8sRtDwiIicMlRPNvaLXn9X8=");
_c = Todo;
...
//# sourceMappingURL=_2e75da._.js.map